...
urlpatterns = [
    ...
    path('history/<str:level>/<str:prog>/<str:session>/',
    ...
    path('lecturer_upload/', views.lecturerUploadPage, name='lecturerUploadPage'),
    path('lecturer_page/', views.lecturerPage, name='lecturerPage'),
    path('create_lecturer/', views.createLecturer, name='createLecturer'),
    path('lecturer_update/<str:pk>/', views.updateLecturer, name='updateLecturer'),
    path('lecturer_delete/<str:pk>/', views.deleteLecturer, name='deleteLecturer'),

    path('course_upload/', views.courseUploadPage, name='courseUpload'),
    path('teaching_load/', views.techingPage, name='Teaching'),
    path('teaching_load_history/', views.teachingHistory, name='teachingHistory'),

    path('test/', views.test, name='test'),
    path('testable/', views.tabledata, name=''),
    ...
    path('update_programme/<str:pk>/',
         views.updateProgramme, name='updateProgramme'),
    path('delete_programme/<str:pk>/',
         views.deleteProgramme, name='deleteProgramme'),
    path('student_raw_data/', views.rawDatePage, name='studRaw'),

    path('change_password/',
         auth_views.PasswordChangeView.as_view(
             template_name='computation/password_change.html'),
         name='password_change'),
    path('change_password/done/',
         auth_views. PasswordChangeDoneView.as_view(
             template_name='computation/password_change_done.html'),
    ...
    path('reset_password/',
         auth_views.PasswordResetView.as_view(
             template_name='computation/password_rest.html'),
         name='reset_password'),
    path('reset_password_sent/',
         auth_views.PasswordResetDoneView.as_view(
             template_name='computation/password_rest_sent.html'),
         name='password_reset_done'),
    path('reset/<uidb64>/<token>/',
         auth_views.PasswordResetConfirmView.as_view(
             template_name='computation/password_rest_form.html'),
         name='password_reset_confirm'),
    path('reset_password_complete/',
         auth_views.PasswordResetCompleteView.as_view(
             template_name='computation/password_rest_done.html'),
